...
class Histogram {
 protected:
  ...
  TH1D_ptr E_x_mu = std::make_shared<TH1D>("Energy (x_mu = e(p,p')e')", "Energy (x_mu = e(p,p')e')", 500, -2.0, 9.0);
  TH1D_ptr P_x_mu = std::make_shared<TH1D>("mom (x_mu = e(p,p')e')", "mom (x_mu = e(p,p')e')", 500, -0.50, 9.0);
  ...
  TH1D_ptr Pz_x_mu = std::make_shared<TH1D>("Pz (x_mu = e(p,p')e')", "Pz (x_mu = e(p,p')e')", 500, -1.0, 9.0);

  TH1D_ptr diff_E_P_x_mu =
      std::make_shared<TH1D>("Energy-Mom(x_mu = e(p,p')e')", " (Energy-Mom) of (x_mu = e(p,p')e')", 500, -1.0, 1.5);
